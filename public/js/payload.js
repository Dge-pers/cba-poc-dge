...
var PayloadPanel = (function() {
  ...
  function togglePanel(event, element) {
    ...
    if (element.classList.contains('full')) {
        ...
        document.getElementById('sliderImg').src='../img/buttons/slideLeft.png';
        document.getElementById('logSub').style.width='calc(60% + 2rem)';
        document.getElementById('logSub').style.margin='0 0 0 calc(40% - 2rem)';
        document.getElementById('mic-holder').style.display='inline-flex';
        if ($(window).width() < 750){document.getElementById('sliderImg').style="margin: 0.5rem 0.8rem"};
        if ($(window).width() < 750){document.getElementById('sliderTriangle').style="border-left: 3rem solid transparent"};
        if(document.getElementById('frameViewer')!=null) document.getElementById('frameViewer').style.margin='4% 0 0 0';
      } else {
        element.classList.add('full');
        payloadColumn.classList.add('full');
        document.getElementById('sliderImg').src='../img/buttons/slideRight.png';
        document.getElementById('logSub').style.width='100%';
        document.getElementById('logSub').style.margin='0';
        document.getElementById('mic-holder').style.display='none';
        if ($(window).width() < 750){document.getElementById('sliderImg').style="margin: 0 1rem 0 0"};
        if ($(window).width() < 750){document.getElementById('sliderTriangle').style="border-left: 0 solid transparent"};
        if(document.getElementById('frameViewer')!=null) document.getElementById('frameViewer').style.margin='auto';
      }
  }
